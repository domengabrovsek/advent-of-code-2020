...
const getNumberOfLettersOccurencesInString = (string, letter) => {
...
const getValidPasswords = (input) => {
  ...
  for (const row of input) {
    ...
    const noOfOccurences = getNumberOfLettersOccurencesInString(password, letter);
...
console.log(result.partOne.length);
console.log(result.partTwo.length);
